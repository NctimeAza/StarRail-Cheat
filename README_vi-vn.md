...
## Phiên bản ổn định
1. Truy cập vào mục [release](https://github.com/Papaya-Group/Akebi-GC/releases)
2. Tải về file chạy mới nhất
## Phiên bản mới nhất
1. Truy cập vào mục [Action](https://github.com/Papaya-Group/Akebi-GC/actions)
...
Tham khảo trang wiki - [Building](https://github.com/Papaya-Group/Akebi-GC/wiki/Building%EF%BD%9C%E5%BB%BA%E7%BD%AE)
...
1. [Báo cáo lỗi](https://github.com/Papaya-Group/Akebi-GC/issues)
...
2. [Tạo Pull Request](https://github.com/Papaya-Group/Akebi-GC/pulls)

## Góp ý

(VUI LÒNG SỬ DỤNG TIẾNG ANH!)

Để đóng góp ý tưởng cho dự án hãy tạo một [issue](https://github.com/Papaya-Group/Akebi-GC/issues) với tiêu đề là ý tưởng bạn muốn.
